...
async function setupDatabase() {
  ...
  try {
    ...
    // We skip RLS since we connect with postgres directly or through the anon key with pg configuration
    // (for this internal dashboard the Anon key will have RLS policies set to allow all but pg-client has direct access)
